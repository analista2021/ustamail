...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width: 1500px" id="mdialTamanio">
...
SUGERENCIA Y OBSERVACIONES: mesadeayuda@usantotomas.edu.co
    ...
    <div id="mensaje">
        <center><font color="red">Recuerde que ahora las cuentas de correo institucionales est&aacute;n administradas por Microsoft&reg;; para ingresar a este sitio por favor dar click <a href="https://www.outlook.com" target="_blank">aqu&iacute;</a></font></center>
    </div>